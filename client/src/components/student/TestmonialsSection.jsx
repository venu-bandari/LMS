    ...
    <div className='pb-14 px-8 md:px-0'>
      ...
      <div className='grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-8 mt-14'>
        {dummyTestimonial.map((testimonial,index)=>(
          ...
          pb-6 rounded-lg bg-white shadow-[opx_4px_15px_0px] shadow-black/5 overflow-hidden'>
            ...
            <div className='p-5 pb-7'>
                <div className='flex gap-0.5'>
                  {[...Array(5)].map((_,i)=>(<img className=' h-5' key={i} src={i<Math.floor(testimonial.rating)
